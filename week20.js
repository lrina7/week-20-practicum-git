...
/*function makeTwo() {
	...
	const e = 7; 
	try {
		e = 5; //пытается перезаписать константу e
		resultTwo.textContent = e;
		console.log ('Функция вызвана без ошибок');
	} catch (error) {
...
/*function makeFour() {
	...
	try {
		...
		c = 15;
		let a = b * c;
		result4.textContent = a;
		console.log('Функция вызвана без ошибок');
	} catch (error) {
		result4.textContent = 'Ошибка была перехвачена: ' + error.message;
		console.error('Ошибка была перехвачена:', error.message);
	}
}
...
/*function makeTwelve() {
	...
	if (age < 18) {
		//Ваш код
		 result.textContent = "Доступ запрещен для лиц младше 18 лет";
	} else {
		//Ваш код
		result.textContent = "Доступ разрешен";
  }
}
...
/*function makeFourteen() {
	...
	try {
		...
		document.getElementById('result14').textContent = discount;
	} catch(error) {
...
/*function makeSixteen(n, func) {
	...
	try {
		...
		resultSixteen.textContent = error;
	}
}
...
/*function makeSeventeen(str, func) {
	...
	try {
		...
		resultSeventeen.textContent = error;
	}
}
...
/*function makeEighteen() {
	...
	forWordFinally.textContent = 'finnaly'; //Блок finally
}
}
...
/*function makeNineteen() {
	...
	const forWordFinallyNineteen = document.getElementById('result19a');
	//Блок try
	try {
	const arr = [1, 2, 3];
	...
	console.error(error); //Вывод ошибки в консоль
	//Ваш код
	resultNineteen.textContent = error;
} finally {
  forWordFinallyNineteen.textContent = "finally19"; //Блок finally
}
}
...
const forWordFinallyTwenty = document.getElementById('result20a');
...
function makeTwenty() {
	...
	try {
		...
		resultTwenty.textContent = error.mesage;
	} finally {
		forWordFinallyTwenty.textContent = "finally20";
	}
}
...
/*let resultTwentyOne = document.getElementById('result21');
let forWordFinallyTwentyOne = document.getElementById('result21a');
...
function makeTwentyOne() {
	...
	try {
		...
		forWordFinallyTwentyOne.textContent = "finally21";
	}
}
